...
% compute_parameterization - compute a planar parameterization  计算平面参数化
%
...
%           is specified by options.boundary which is either
%           'circle', 'square' or 'triangle'. The kind of laplacian used is specified
%           by options.laplacian which is either 'combinatorial' or 'conformal'
%解决经典参数,指定的边界的选择。边界,要么是“圆”、方形 或者是三角形. 的拉普拉斯算子使用指定的选项。拉普拉斯算子是“组合”或“形”
...
%   of a given disk-like triangulated manifold.计算一个给定盘状的平面参数化分析多方面的。
%
